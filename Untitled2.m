function [SCORE_test,SCORE_imp]=AdaptiveTnormFastScr(ivector_train,y,ivector_test,ivector_imp)
%-----------------------
%adaptive tnorm
...
index_norm=zeros(size(ivector_train,1),20);
for i=1:size(ivector_train,1)
    [a,b]=sort(SCORE_norm(i,:),'descend');
    index_norm(i,1:20)=b(1:20);
end
%-----------------------
SCORE_test=[];
for i=1:size(ivector_train,1)
