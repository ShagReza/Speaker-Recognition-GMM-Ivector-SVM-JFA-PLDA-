...
for chan = 1: size(gain,1)
    y1=ARMA_filter([A0(chan)/gain(chan) A11(chan)/gain(chan) ...
        A2(chan)/gain(chan)], ...
        [B0(chan) B1(chan) B2(chan)], x);
    y2=ARMA_filter([A0(chan) A12(chan) A2(chan)], ...
        [B0(chan) B1(chan) B2(chan)], y1);
    y3=ARMA_filter([A0(chan) A13(chan) A2(chan)], ...
        [B0(chan) B1(chan) B2(chan)], y2);
    y4=ARMA_filter([A0(chan) A14(chan) A2(chan)], ...
