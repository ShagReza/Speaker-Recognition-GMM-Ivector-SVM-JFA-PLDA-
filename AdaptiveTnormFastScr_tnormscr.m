function [SCORE_test,SCORE_imp,index_norm]=AdaptiveTnormFastScr_tnormscr(ivector_train,y,ivector_test,ivector_imp)
Ntnorm=500;
%-----------------------
%adaptive tnorm
...
for i=1:size(ivector_train,1)
    ...
    %---
    scrtotal=[scr;scr_norm];
    %scrtotal=ApplyLLR2(exp(0.5*scrtotal+0.5));
    scrtotal=Applytnorm(scrtotal);
