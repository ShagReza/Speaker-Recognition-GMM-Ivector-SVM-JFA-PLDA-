function [SCORE_test,SCORE_imp,index_norm]=AdaptiveTnormFastScr_tnormexpscr(ivector_train,y,ivector_test,ivector_imp)
Ntnorm=500;
%-----------------------
%adaptive tnorm
...
for i=1:size(ivector_train,1)
    ...
    %---
    scrtotal=[scr;scr_norm];
    scrtotal=Applytnorm(exp(scrtotal));
    %scrtotal=Applytnorm2(exp(scrtotal));
