...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Test:
function [DataTestSvm,SCORE,classTest,CLASS,NumOfSegments,NumOfTest]=ImposterIvector(pathstates,IvectorSvmpath,JFA_eigen_lists,OneVersusRest,Norm_ivector,LDA_ivector,NAP_ivector,WCCN_ivector,LDAmodel,P_NAP,B_WCCN,NormScrs,NormScrs_target)
iter=10;
load(pathstates);
