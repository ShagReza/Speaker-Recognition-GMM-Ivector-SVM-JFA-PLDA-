...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Test:
function [DataTestSvm,ivector_test,classTest,CLASS,NumOfSegments,NumOfTest]=TestIvector_LVM(pathstates,IvectorSvmpath,JFA_eigen_lists,vLVM,CSV,J)
iter=10;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Test:
function [DataTestSvm,ivector_test,classTest,CLASS,NumOfSegments,NumOfTest]=TestIvector2(pathstates,IvectorSvmpath,JFA_eigen_lists)
iter=10;
load( [pathstates,'\Methods'] );
load( [pathstates,'\Path']);
load( [pathstates,'\Param'] );
